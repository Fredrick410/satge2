...
<head>
    ...
    <title>Ajouter un particulier</title>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Nom :</label>
                                                            <input name="name_client" type="text" class="form-control" placeholder="Nom du particulier" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*prenom :</label>
                                                            <input name="prenom" type="text" class="form-control" placeholder="Prénom du particulier" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <div class="form-group">
