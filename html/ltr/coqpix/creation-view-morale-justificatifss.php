...
require_once 'php/verif_session_crea.php';
    ...
    if (is_uploaded_file($_FILES['justificatifss']['tmp_name'])) {
    echo "File ". $_FILES['justificatifss']['name'] ." téléchargé avec succès.\n";
    $dir = '../../../src/crea_societe/justificatifss/';
    ...
    $name_files = $_FILES['justificatifss']['name'];                         
    $date_now = '-'.date("H-i-s");
    $type_files = "." . strtolower(substr(strrchr($name_files, '.'), 1));
    $target_file = $_FILES['justificatifss']['tmp_name'];                                     
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        ...
        header('Location: creation-view-morale-justificatifss.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-morale-justificatifss.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-morale-justificatifss.php?upload=3');
       exit(); 
}
   ...
   echo "Nom du fichier : '". $_FILES['justificatifss']['tmp_name'] . "'.";
}
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-morale-justificatifss.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group text-center border">
                            <br>
                            <h1>Justificatif de siège social (Attestation de domicile)</h1>
                        </div>
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center">
                                    <img src="../../../app-assets/images/ico/photojustificatifss.png" alt="photocerfa" class="img-fluid"> 
                                    <div class="form-group">
                                        <br>
                                    </div>   
                                    <label class="line">Pour télécharger votre justificatif de siège social (Attestation de domiciliation)</label><br>
                                    <a href="../../../src/crea_societe/justificatifss/justificatifss-coqpix.pdf" download><label class="livicon-evo" data-options=" name: download.svg; size: 25px "></label></a>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="form-group">
                                <form name="myform" action="" method="POST" enctype="multipart/form-data">
	                                ...
	                                <input class="input-file" id="my-file" onchange="this.form.submit();" type="file"  name="justificatifss" size="30" accept="image/png, image/jpg, image/jpeg, application/pdf">
                        ...
                        <div class="row no-gutters mt-3">
                            <div class="col"></div>
                            <div class="col text-center">
                                <div class="form-group <?php if(substr($crea['doc_justificatifss'], -3) == "pdf"){echo "block-validation";}else{echo "none-validation";} ?>">
                                    <embed src=../../../src/crea_societe/justificatifss/<?= $crea['doc_justificatifss'] ?> width=800 height=900 type='application/pdf'/>
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_justificatifss'], -3) == "png"){echo "block-validation";}else{if(substr($crea['doc_justificatifss'], -3) == "jpg"){echo "block-validation";}else{if(substr($crea['doc_justificatifss'], -3) == "jpeg"){echo "block-validation";}else{ echo "none-validation";}}} ?>">
                                    <label>Apercu de votre document</label>
                                    <img src="../../../src/crea_societe/justificatifss/<?= $crea['doc_justificatifss'] ?>" alt="Photoid" class="img-fluid">
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_justificatifss'], -3) == "png"){echo "none-validation";}else{if(substr($crea['doc_justificatifss'], -3) == "jpg"){echo "none-validation";}else{if(substr($crea['doc_justificatifss'], -3) == "jpeg"){echo "none-validation";}else{ if(substr($crea['doc_justificatifss'], -3) == "jpeg"){ echo "block-validation";}else{if(substr($crea['doc_justificatifss'], -3) == "pdf"){echo "none-validation";}else{if(substr($crea['doc_justificatifss'], -3) == ""){echo "none-validation";}else{echo "block-validation";}}}}}} ?>">
