                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center border-right">
                                    <img src="../../../app-assets/images/ico/photojustificatifss.png" alt="photocerfa" class="img-fluid h-100 p-1 "> 
                                    <div class="form-group">
                                    <br>
                                    </div>
                                    <label id="download-doc">Pour télécharger votre justificatif de siège social :</label><br>
