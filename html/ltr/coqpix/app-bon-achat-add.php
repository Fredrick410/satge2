...
require_once 'php/config.php';
	...
	$incre = $bdd->prepare('SELECT MAX(id) FROM bon_commande ');
	$incre->execute();
	$test = $incre->fetch();
	$maxid = $test['MAX(id)'] + 1;
	...
	$max_num = "";
	$pdoSt = $bdd->prepare('SELECT id FROM bon_commande');
		$pdoSt->bindValue(':num',$_SESSION['id_session']); //$_SESSION
		$pdoSt->execute(); 
		$num = $pdoSt->fetchAll();
		$count_num = count($num);
											...
											<div class="row invoice-info">
												<div class="col-lg-6 col-md-12 mt-25">
													<div class="form-group">
														...
														<select name="nom_fournisseur" id="fournisseur" class="form-control invoice-item-select">
