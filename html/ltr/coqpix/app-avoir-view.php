...
require_once 'php/permissions_front.php';
    ...
    $pdo = $bdd->prepare('SELECT * FROM articles WHERE id_session = :num AND numeros=:numeros AND typ = "avoirvente"');
    ...
    $sq = "SELECT SUM(R.TOTA) as MONTANT_R FROM ( SELECT cout,quantite,remise ,(((cout * quantite) * (1 - (remise/100)))) as TOTA FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' ) R ";
    ...
    $sql = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' ) V ";
    ...
    $sqlt20 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva = '20 %' ) V ";
    ...
    $sqlm20 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva='20 %' ) T ";
    ...
    $sqlt10 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva = '10 %' ) V ";
    ...
    $sqlm10 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva='10 %' ) T ";
    ...
    $sqlt55 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva = '5,5 %' ) V ";
    ...
    $sqlm55 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva='5,5 %' ) T ";
    ...
    $sqlt21 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva = '2,1 %' ) V ";
    ...
    $sqlm21 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='avoirvente' AND tva='2,1 %' ) T ";
                                    ...
                                    <div class="card-body pb-0 mx-25">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-4 col-md-12">
                                                <span class="invoice-number mr-50">Avoir N°</span><span><?= $facture['numerosavoir']; ?></span>
                                            </div>
                                        ...
                                        <div class="row my-3">
                                            <div class="col-6">
                                                <h4 class="text-primary">Avoir</h4>
                                        ...
                                        <div class="row invoice-info">
                                            <div class="col-6 mt-1">
                                                <h5 class="invoice-from">Avoir de</h5>
                                                <div class="mb-1">
                                            ...
                                            <div class="col-6 mt-1">
                                                <h5 class="invoice-to">Avoir pour</h5>
                                                <div class="mb-1">
                                                    <span><?= $facture['avoirpour']; ?></span>
                                                </div>
                                                <div class="mb-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 col-sm-6 d-flex justify-content-end mt-75">
                                                <div class="invoice-subtotal">
                                                    ...
                                                    <hr>
                                                    <div class="invoice-calc d-flex justify-content-between">
                                                        <span class="invoice-subtotal-title">Modalité de payement :</span>
                        ...
                        <div class="col-xl-3 col-md-4 col-12">
                            <div class="card invoice-action-wrapper shadow-none border">
                                <div class="card-body">
                                    ...
                                    <div class="invoice-action-btn">        
                                        <form action="app-avoir-list.php"><input value="Retour" type="submit" class="btn btn-success btn-block"></form>               
                                    </div>
                                    <hr>
                                    ...
                                    <!-- COULEUR -->
                                    <div class="form-group">
                                        <h6 class="line">Thème de couleur :</h6>
                                    </div>
                                    <div class="form-group">
                                        <label>Bientôt<label>
                                    </div>
