...
require_once 'php/get_documents_physique.php';
    ...
    if (is_uploaded_file($_FILES['peirl']['tmp_name'])) {
    echo "File ". $_FILES['peirl']['name'] ." téléchargé avec succès.\n";
    $dir = '../../../src/crea_societe/peirl/';
    ...
    $name_files = $_FILES['peirl']['name'];                         
    $date_now = '-'.date("H-i-s");
    $type_files = "." . strtolower(substr(strrchr($name_files, '.'), 1));
    $target_file = $_FILES['peirl']['tmp_name'];                                     
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        $update = $bdd->prepare('UPDATE crea_societe SET doc_peirl = ? WHERE id = ?');
        $update->execute(array( ($real_name . $date_now . $type_files), $num  ));

        header('Location: creation-view-physique-peirl.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-physique-peirl.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-physique-peirl.php?upload=3');
       exit(); 
}
   ...
   echo "Nom du fichier : '". $_FILES['peirl']['tmp_name'] . "'.";
}
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-physique-peirl.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center">  
                                <img src="../../../app-assets/images/ico/photopeirl.png" alt="photoxp" class="img-fluid">
                                <label>Télécharger le document</label>&nbsp&nbsp&nbsp<a href="../../../src/crea_societe/peirl/peirl-coqpix.pdf" download><label class="livicon-evo" data-options=" name: download.svg; size: 25px "></label></a>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="form-group">
                                <form name="myform" action="" method="POST" enctype="multipart/form-data">
	                                ...
	                                <input class="input-file" id="my-file" onchange="this.form.submit();" type="file"  name="peirl" size="30" accept="image/png, image/jpg, image/jpeg, application/pdf">
                        ...
                        <div class="row no-gutters mt-3">
                            <div class="col"></div>
                            <div class="col text-center">
                                <div class="form-group <?php if(substr($crea['doc_peirl'], -3) == "pdf"){echo "block-validation";}else{echo "none-validation";} ?>">
                                    <embed src=../../../src/crea_societe/peirl/<?= $crea['doc_peirl'] ?> width=800 height=900 type='application/pdf'/>
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_peirl'], -3) == "png"){echo "block-validation";}else{if(substr($crea['doc_peirl'], -3) == "jpg"){echo "block-validation";}else{if(substr($crea['doc_peirl'], -3) == "jpeg"){echo "block-validation";}else{ echo "none-validation";}}} ?>">
                                    <label>Apercu de votre document</label>
                                    <img src="../../../src/crea_societe/peirl/<?= $crea['doc_peirl'] ?>" alt="Photoid" class="img-fluid">
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_peirl'], -3) == "png"){echo "none-validation";}else{if(substr($crea['doc_peirl'], -3) == "jpg"){echo "none-validation";}else{if(substr($crea['doc_peirl'], -3) == "jpeg"){echo "none-validation";}else{ if(substr($crea['doc_peirl'], -3) == "jpeg"){ echo "block-validation";}else{if(substr($crea['doc_peirl'], -3) == "pdf"){echo "none-validation";}else{if(substr($crea['doc_peirl'], -3) == ""){echo "none-validation";}else{echo "block-validation";}}}}}} ?>">
