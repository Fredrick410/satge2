...
require_once 'php/verif_connexion_comptable.php';
     ...
     $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="01"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $janvier = $pdoSt->fetchAll();
    $count_jan = count($janvier);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="01" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $janvier_notif = $pdoSt->fetchAll();
    $count_jan_notif = count($janvier);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="02"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $fevrier = $pdoSt->fetchAll();
    $count_fev = count($fevrier);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="02" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $fevrier_notif = $pdoSt->fetchAll();
    $count_fev_notif = count($fevrier);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="03"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $mars = $pdoSt->fetchAll();
    $count_mar = count($mars);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="03" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $mars_notif = $pdoSt->fetchAll();
    $count_mar_notif = count($mars);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="04"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $avril = $pdoSt->fetchAll();
    $count_avr = count($avril);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="04" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $avril_notif = $pdoSt->fetchAll();
    $count_avr_notif = count($avril);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="05"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $mai = $pdoSt->fetchAll();
    $count_mai = count($mai);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="05" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $mai_notif = $pdoSt->fetchAll();
    $count_mai_notif = count($mai);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="06"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $juin = $pdoSt->fetchAll();
    $count_jui = count($juin);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="06" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $juin_notif = $pdoSt->fetchAll();
    $count_jui_notif = count($juin);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="07"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $juillet = $pdoSt->fetchAll();
    $count_juil = count($juillet);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="07" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $juillet_notif = $pdoSt->fetchAll();
    $count_juil_notif = count($juillet);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="08"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $aout = $pdoSt->fetchAll();
    $count_aou = count($aout);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="08" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $aout_notif = $pdoSt->fetchAll();
    $count_aou_notif = count($aout);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="09"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $septembre = $pdoSt->fetchAll();
    $count_sep = count($septembre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="09" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $septembre_notif = $pdoSt->fetchAll();
    $count_sep_notif = count($septembre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="10"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $octobre = $pdoSt->fetchAll();
    $count_oct = count($octobre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="10" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $octobre_notif = $pdoSt->fetchAll();
    $count_oct_notif = count($octobre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="11"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $novembre = $pdoSt->fetchAll();
    $count_nov = count($novembre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="11" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $novembre_notif = $pdoSt->fetchAll();
    $count_nov_notif = count($novembre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="12"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
    $decembre = $pdoSt->fetchAll();
    $count_dec = count($decembre);

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND type_files_note="note" AND dte_m="12" AND num_saisie="pas de numeros"');   
    $pdoSt->bindValue(':num',$_GET['num'], PDO::PARAM_INT);
    $pdoSt->execute();  
                        ...
                        <div class="app-file-sidebar-left">
                            ...
                            <div class="app-file-sidebar-content">
                                ...
                                <div class="list-group list-group-labels my-50">
                                    ...
                                    <a href="cloudpix-note.php" class="list-group-item list-group-item-action active">
                                        <div class="fonticon-wrap d-inline mr-25">
