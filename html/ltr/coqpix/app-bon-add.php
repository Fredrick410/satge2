        ...
        if($_GET['jXN955CbHqqbQ463u5Uq'] == "Rt82u"){
            ...
            for ($i=0; $i < $count_incrementation ; $i++) { 
                foreach($incrementation as $incrementations):
                    ...
                    $numeros = $incrementations['numerobon'];
                                ...
                                <form autocomplete="off" action="php/insert_bon.php" method="POST">
                                        ...
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1">
                                                ...
                                                <input name="nomproduit" id="nomproduit" type="text" class="form-control" placeholder="Nom du bon de livraison"> 
                                            </div>
                                        ...
                                        <div class="row invoice-info">
											...
											<div class="col-lg-6 col-md-12 mt-25" style="
    padding-top: 0px;
">
												<div class="form-group">
                                                        ...
                                                        <div class="invoice-item d-flex border rounded mb-1">
                                                            <div class="invoice-item-filed row pt-1 px-1">
                                                                ...
                                                                <div class="col-md-3 col-12 form-group">
                                                                    <input name="cout" min="1" id="cout" type="number" class="form-control" placeholder="0" onkeyup="myFunction()" step="any">
                                                                </div>
                                                                <div class="col-md-3 col-12 form-group">
                                                                    <input name="quantite" min="1" id="quantite" type="number" value="1" class="form-control" placeholder="0" onkeyup="myFunction()" step="any">
                                                                </div> 
