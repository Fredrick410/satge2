...
require_once 'php/config.php';
    ...
    $pdoStat = $bdd->prepare('SELECT * FROM task_sociale');
    $pdoStat->execute();
                    ...
                    <div class="todo-sidebar d-flex">
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group">
                                    <a href="task-sociale-filtre.php?filter=favo" class="list-group-item border-0">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: star.svg; size: 24px; style: lines; strokeColor:#475f7b; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Favoris</span>
                                    </a>
                                    <a href="task-sociale-filtre.php?filter=valide" class="list-group-item border-0">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: check.svg; size: 24px; style: lines; strokeColor:#475f7b; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Valide</span>
                                    </a>
                                    <a href="task-sociale-filtre.php?filter=en cours" class="list-group-item border-0">
                                        <span class="fonticon-wrap mr-50">
