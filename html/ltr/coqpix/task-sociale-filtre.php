...
require_once 'php/config.php';
    ...
    if($_GET['filter']=="favo"){
        $pdoStat = $bdd->prepare('SELECT * FROM task_sociale WHERE favo_task="yes"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
    }
    else{
        $pdoStat = $bdd->prepare('SELECT * FROM task_sociale WHERE statut_task="'.$_GET['filter'].'"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-static-top navbar-brand-center" style="background-color: #3c91d5;">
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="dashboard-admin.php"><div class="brand-logo"><img class="logo" src="../../../app-assets/images/logo/coqpix1.png"></div></a></li>
            </ul>
        </div>
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                <div class="list-group">
                                    <a href="task-sociale.php" class="list-group-item border-0">
                                ...
                                <div class="list-group">
                                    <a href="task-sociale-filtre.php?filter=favo" class="list-group-item border-0 <?php if($_GET['filter'] == "favo"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: star.svg; size: 24px; style: lines; strokeColor:<?php if($_GET['filter'] == "favo"){echo "#475f7b";}else{echo "#475f7b";} ?>; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Favoris</span>
                                    </a>
                                    <a href="task-sociale-filtre.php?filter=valide" class="list-group-item border-0 <?php if($_GET['filter'] == "valide"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: check.svg; size: 24px; style: lines; strokeColor:<?php if($_GET['filter'] == "valide"){echo "#475f7b";}else{echo "#475f7b";} ?>; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Valide</span>
                                    </a>
                                    <a href="task-sociale-filtre.php?filter=en cours" class="list-group-item border-0 <?php if($_GET['filter'] == "en cours"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: timer.svg; size: 24px; style: lines; strokeColor:<?php if($_GET['filter'] == "en cours"){echo "#475f7b";}else{echo "#475f7b";} ?>; eventOn:grandparent;"></i>
                                        </span>
                                        <span>En cours</span>
                                    </a>
                                </div>
                                ...
                                <div class="form-group">
                                    <form action="php/insert_task_back.php?type=sociale" method="POST">
                                        <div class="form-group">
                                                        ...
                                                        <div class="todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="btn-group ml-2">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right pt-1 px-1" style="min-width: 250px;">
                                                                    <div class="form-group">
                                                                        <form method="POST" action="php/change_task_back.php?num=<?= $tasks['id'] ?>&type=editer_task&categorie=sociale&filter=<?= $_GET['filter'] ?>">
                                                                            <div class="form-group">
                                                                                <label>Nom de la tache <label class="text-danger">*</label></label>
