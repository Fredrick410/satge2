...
ini_set('display_startup_errors', TRUE);
    ...
    if($_GET['type'] == "frais"){
        ...
        if ($bilan['frais_bilan'] == ''.$frais_0.'!yes!'.$frais_2.'') {
                $end = '!no!';
        }else{
                $end = '!yes!';
        }
        
        $final = $frais_0.$end.$frais_2;
    ...
    if($_GET['type'] == "greffe"){
        ...
        if ($bilan['greffe_bilan'] == ''.$greffe_0.'!yes!'.$greffe_2.'') {
                $end = '!no!';
        }else{
                $end = '!yes!';
        }
        
        $final = $greffe_0.$end.$greffe_2;
    ...
    if($_GET['type'] == "age"){
        ...
        if ($bilan['age_bilan'] == ''.$age_0.'!yes!'.$age_2.'') {
                $end = '!no!';
        }else{
                $end = '!yes!';
        }
        
        $final = $age_0.$end.$age_2;
