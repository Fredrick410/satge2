        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="menu-livicon" data-icon="briefcase"></i><span>Comptabilité</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item align-items-center" href="bilan-back.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Bilan</a>
                    </li>
                    <li data-menu=""><a class="dropdown-item align-items-center" href="portefeuille.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Portefeuille compta</a>
                    </li>
                    <li data-menu=""><a class="dropdown-item align-items-center" href="task-compta.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Tache compta</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="menu-livicon" data-icon="umbrella"></i><span>Social</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item align-items-center" href="attestation-sociale-back.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Attestation social</a>
                    </li>
                    ...
                    <li data-menu=""><a class="dropdown-item align-items-center" href="portefeuille-social.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Portefeuille social</a>
                    </li>
                    <li data-menu=""><a class="dropdown-item align-items-center" href="task-sociale.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Tache sociale</a>
                    </li>
                </ul>
            </li>
            <?php } ?>
            ...
            <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="menu-livicon" data-icon="credit-card-out"></i><span>Fiscal</span></a>
                <ul class="dropdown-menu">
                    ...
                    <li data-menu=""><a class="dropdown-item align-items-center" href="declarationother.php" data-toggle="dropdown"><i class="bx bx-right-arrow-alt"></i>Autres Déclarations</a>
                    </li>
