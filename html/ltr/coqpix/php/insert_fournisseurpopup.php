...
require_once 'config.php';
    ...
    $insert = $bdd->prepare('INSERT INTO fournisseur (name_fournisseur, nom, prenom, adresse_diri, tel_diri, email_diri, numsiret, tvaintracom, pays, adresse, secteur, tel, siteweb, email, iban, id_session) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)');
