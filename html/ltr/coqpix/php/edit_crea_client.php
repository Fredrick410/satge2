...
ini_set('display_startup_errors', TRUE);
    ...
    $pdo = $bdd->prepare('UPDATE crea_societe SET email_crea=:email_crea, nom_diri=:nom_diri, prenom_diri=:prenom_diri, tel_diri=:tel_diri, status_crea=:status_crea, adresse_diri=:adresse_diri, ville_diri=:ville_diri, cp_diri=:cp_diri WHERE id=:num LIMIT 1');
    ...
    $pdo->bindValue(':ville_diri', $_POST['ville_diri']);
    $pdo->bindValue(':cp_diri', $_POST['cp_diri']);
