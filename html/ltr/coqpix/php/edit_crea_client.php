...
ini_set('display_startup_errors', TRUE);
    ...
    $pdo = $bdd->prepare('UPDATE crea_societe SET email_crea=:email_crea, nom_diri=:nom_diri, prenom_diri=:prenom_diri, tel_diri=:tel_diri, status_crea=:status_crea WHERE id=:num LIMIT 1');
