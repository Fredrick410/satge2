...
require_once 'php/get_documents.php';
    ...
    echo "File ". $_FILES['depot']['name'] ." téléchargé avec succès.\n";
    $dir = '../../../src/crea_societe/depot/';
    ...
    $name_files = $_FILES['depot']['name'];                         
    $date_now = '-'.date("H-i-s");
    $type_files = "." . strtolower(substr(strrchr($name_files, '.'), 1));
    $target_file = $_FILES['depot']['tmp_name'];                                     
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        $update = $bdd->prepare('UPDATE crea_societe SET doc_depot = ? WHERE id = ?');
        $update->execute(array( ($real_name . $date_now . $type_files), $num  ));

        header('Location: creation-view-morale-depot.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-morale-depot.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-morale-depot.php?upload=3');
       exit(); 
}
   ...
   echo "Nom du fichier : '". $_FILES['depot']['tmp_name'] . "'.";
}
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-morale-depot.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group text-center border">
                            <br>
                            <h1>Dépot de capital</h1>
                        </div>
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center">
                                    <!-- <img src="../../../app-assets/images/ico/photodepot.png" alt="photodepot" class="img-fluid"> -->
                                    <small>Photo soon</small><br>
                                    <label>Votre document de dépôt de capital doit être fournie par votre banque</label>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="form-group">
                                <form name="myform" action="" method="POST" enctype="multipart/form-data">
	                                ...
	                                <input class="input-file" id="my-file" onchange="this.form.submit();" type="file"  name="depot" size="30" accept="image/png, image/jpg, image/jpeg, application/pdf">
                        ...
                        <div class="row no-gutters mt-3">
                            <div class="col"></div>
                            <div class="col text-center">
                                <div class="form-group <?php if(substr($crea['doc_depot'], -3) == "pdf"){echo "block-validation";}else{echo "none-validation";} ?>">
                                    <embed src=../../../src/crea_societe/depot/<?= $crea['doc_depot'] ?> width=800 height=900 type='application/pdf'/>
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_depot'], -3) == "png"){echo "block-validation";}else{if(substr($crea['doc_depot'], -3) == "jpg"){echo "block-validation";}else{if(substr($crea['doc_depot'], -3) == "jpeg"){echo "block-validation";}else{ echo "none-validation";}}} ?>">
                                    <label>Apercu de votre document</label>
                                    <img src="../../../src/crea_societe/depot/<?= $crea['doc_depot'] ?>" alt="Photoid" class="img-fluid">
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_depot'], -3) == "png"){echo "none-validation";}else{if(substr($crea['doc_depot'], -3) == "jpg"){echo "none-validation";}else{if(substr($crea['doc_depot'], -3) == "jpeg"){echo "none-validation";}else{ if(substr($crea['doc_depot'], -3) == "jpeg"){ echo "block-validation";}else{if(substr($crea['doc_depot'], -3) == "pdf"){echo "none-validation";}else{if(substr($crea['doc_depot'], -3) == ""){echo "none-validation";}else{echo "block-validation";}}}}}} ?>">
