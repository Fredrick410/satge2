                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center border-right">
                                    <img src="../../../app-assets/images/ico/photodepot.png" alt="photodepot" class="img-fluid h-100 p-1">
                                    <label id="download-doc">Votre document de dépôt de capital doit être fournie par votre banque</label>
                            </div>
                            <div class="col">
