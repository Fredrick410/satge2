...
require_once 'php/config.php';
    ...
    $pdoStttt = $bdd->prepare('SELECT * FROM task WHERE id_session = :num AND status_task = :status_task');
    $pdoStttt->bindValue(':num',$_SESSION['id_session']);
    $pdoStttt->bindValue(':status_task',"terminée");
    $pdoStttt->execute();
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group">
                                    ...
                                    <a href="task-done.php" class="list-group-item border-0 active">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: check.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Terminée</span>
                                    </a>
                                            ...
                                            <li class="todo-item" data-name="<?= $task['assignation_task'] ?>">
                                                <div class="todo-title-wrapper d-flex justify-content-sm-between justify-content-end align-items-center">
                                                    ...
                                                    <div class="todo-item-action d-flex align-items-center">
                                                        ...
                                                        <a href="php/favo_task.php?num=<?= $task['id'] ?>" class='todo-item-favorite ml-75'><i class="<?php if($task['favorite'] == "1"){echo "bx bx-star bxs-star warning hoverfav";}else{echo "bx bx-star hoverfav";} ?>"></i></a>
                                                        ...
                                                        <a href="php/corbeille_task.php?num=<?= $task['id'] ?>&page=task" class='todo-item-delete ml-75'><i class="bx bx-trash trashhover"></i></a>
                                                    </div>
                                                </div>
                                            </li>
                                            <?php endforeach ?>
