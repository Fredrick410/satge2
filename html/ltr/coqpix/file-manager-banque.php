...
$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND banque = "banque"');
...
$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND banque = "banque" ORDER BY id DESC LIMIT 4');
$pdoSta->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSta->execute();
$recent = $pdoSta->fetchAll();

$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND banque = "banque" ORDER BY id DESC LIMIT 8');
$pdoSta->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSta->execute();
...
$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="01"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$janvier = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="02"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$fevrier = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="03"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$mars = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="04"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$avril = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="05"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$mai = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="06"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$juin = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="07"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$juillet = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="08"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$aout = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="09"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$septembre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="10"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$octobre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="11"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$novembre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND banque = "banque" AND dte_m="12"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
                        ...
                        <div class="app-file-sidebar-left">
                            ...
                            <div class="app-file-sidebar-content">
                                ...
                                <div class="list-group list-group-messages my-50">
                                    ...
                                    <a href="file-manager-banque.php" class="list-group-item list-group-item-action  active">
                                        <div class="fonticon-wrap d-inline mr-25">
                                            <i class="livicon-evo" data-options="name: bank.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent; duration:0.85;"></i>
                                        </div>
                                        Relevés bancaires
                                    </a>
                                ...
                                <form action="php/insert_files_stockage_banque.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="content-body">
                        ...
                        <div class="app-file-area">
                            ...
                            <div id="div_max" class="app-file-content p-2 <?= $max ?>">
                                <h5>Tous les relevés bancaires</h5>
                                                    ...
                                                    <div class="card-body p-50">
                                                        <div class="app-file-recent-details">
                                                            <div class="app-file-name font-size-small font-weight-bold"><?= $recents['name_files'] ?> - <small style="<?php if ($recents['send_files'] == "#03f322") {
                                                                                                                                                                            ...
                                                                                                                                                                            echo "color: #ff0000;";
                                                                                                                                                                        } ?>"><?php if ($recents['banque'] == "banque") {
                                                                                                                                                                                                                                                                                echo "Relevés bancaires";
                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                echo "ERROR REPORT PLEASE";
                                                                                                                                                                                                                                                                            } ?></small></div>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $marss['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $marss['name_files'] ?>&size_files=<?= $marss['size_files'] ?>&dte_files=<?= $marss['dte_files'] ?>&dte_j=<?= $marss['dte_j'] ?>&dte_m=<?= $marss['dte_m'] ?>&dte_a=<?= $marss['dte_a'] ?>&img_files=<?= $marss['img_files'] ?>&type_files_note=<?= $marss['type_files_note'] ?>&type_files_avoir=<?= $marss['type_files_avoir'] ?>&type_files_fac_achat=<?= $marss['type_files_fac_achat'] ?>&banque=<?= $marss['banque'] ?>&type_files_caisse_ventes=<?= $marss['type_files_caisse_ventes'] ?>&banque=<?= $marss['banque'] ?>&send_files=<?= $marss['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $marss['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $juinn['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $juinn['name_files'] ?>&size_files=<?= $juinn['size_files'] ?>&dte_files=<?= $juinn['dte_files'] ?>&dte_j=<?= $juinn['dte_j'] ?>&dte_m=<?= $juinn['dte_m'] ?>&dte_a=<?= $juinn['dte_a'] ?>&img_files=<?= $juinn['img_files'] ?>&type_files_note=<?= $juinn['type_files_note'] ?>&type_files_avoir=<?= $juinn['type_files_avoir'] ?>&type_files_fac_achat=<?= $juinn['type_files_fac_achat'] ?>&banque=<?= $juinn['banque'] ?>&type_files_caisse_ventes=<?= $juinn['type_files_caisse_ventes'] ?>&banque=<?= $juinn['banque'] ?>&send_files=<?= $juinn['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $juinn['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $aout['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $aout['name_files'] ?>&size_files=<?= $aout['size_files'] ?>&dte_files=<?= $aout['dte_files'] ?>&dte_j=<?= $aout['dte_j'] ?>&dte_m=<?= $aout['dte_m'] ?>&dte_a=<?= $aout['dte_a'] ?>&img_files=<?= $aout['img_files'] ?>&type_files_note=<?= $aout['type_files_note'] ?>&type_files_avoir=<?= $aout['type_files_avoir'] ?>&type_files_fac_achat=<?= $aout['type_files_fac_achat'] ?>&banque=<?= $aout['banque'] ?>&type_files_caisse_ventes=<?= $aout['type_files_caisse_ventes'] ?>&banque=<?= $aout['banque'] ?>&send_files=<?= $aout['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $aout['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $septembree['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $septembree['name_files'] ?>&size_files=<?= $septembree['size_files'] ?>&dte_files=<?= $septembree['dte_files'] ?>&dte_j=<?= $septembree['dte_j'] ?>&dte_m=<?= $septembree['dte_m'] ?>&dte_a=<?= $septembree['dte_a'] ?>&img_files=<?= $septembree['img_files'] ?>&type_files_note=<?= $septembree['type_files_note'] ?>&type_files_avoir=<?= $septembree['type_files_avoir'] ?>&type_files_fac_achat=<?= $septembree['type_files_fac_achat'] ?>&banque=<?= $septembree['banque'] ?>&type_files_caisse_ventes=<?= $septembree['type_files_caisse_ventes'] ?>&banque=<?= $septembree['banque'] ?>&send_files=<?= $septembree['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $septembree['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                                ...
                                                                <div class="card-body p-50">
                                                                    <div class="app-file-recent-details">
                                                                        <div class="app-file-name font-size-small font-weight-bold"><?= $septembree['name_files'] ?> - <small style="<?php if ($septembree['send_files'] == "#03f322") {
                                                                                                                                                                                            ...
                                                                                                                                                                                            echo "color: #ff0000;";
                                                                                                                                                                                        } ?>"><?php if ($septembree['banque'] == "banque") {
                                                                                                                                                                                                                                                                                                    echo "Relevés bancaires";
                                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                                    echo "ERROR REPORT PLEASE";
                                                                                                                                                                                                                                                                                                } ?></small></div>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $octobree['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $octobree['name_files'] ?>&size_files=<?= $octobree['size_files'] ?>&dte_files=<?= $octobree['dte_files'] ?>&dte_j=<?= $octobree['dte_j'] ?>&dte_m=<?= $octobree['dte_m'] ?>&dte_a=<?= $octobree['dte_a'] ?>&img_files=<?= $octobree['img_files'] ?>&type_files_note=<?= $octobree['type_files_note'] ?>&type_files_avoir=<?= $octobree['type_files_avoir'] ?>&type_files_fac_achat=<?= $octobree['type_files_fac_achat'] ?>&banque=<?= $octobree['banque'] ?>&type_files_caisse_ventes=<?= $octobree['type_files_caisse_ventes'] ?>&banque=<?= $octobree['banque'] ?>&send_files=<?= $octobree['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $octobree['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                                    <img class="d-block mx-auto" src="../../../app-assets/images/icon/<?php $img_files = $septembree['img_files'];
                                                                                                                                        if ($img_files == "pdf") {
                                                                                                                                            $img_files = "pdf.png";
                                                                                                                                        } else {
                                                                ...
                                                                <div class="card-body p-50">
                                                                    <div class="app-file-recent-details">
                                                                        <div class="app-file-name font-size-small font-weight-bold"><?= $novembree['name_files'] ?> - <small style="<?php if ($novembree['send_files'] == "#03f322") {
                                                                                                                                                                                        ...
                                                                                                                                                                                        echo "color: #ff0000;";
                                                                                                                                                                                    } ?>"><?php if ($novembree['banque'] == "banque") {
                                                                                                                                                                                                                                                                                                echo "Relevés bancaires";
                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                echo "ERROR REPORT PLEASE";
                                                                                                                                                                                                                                                                                            } ?></small></div>
                                                        ...
                                                        <div class="card border shadow-none mb-1 app-file-info">
                                                            <div class="card-content">
                                                                <div class="app-file-content-logo card-img-top">
                                                                    ...
                                                                    <a href="loading/button_valid.php?id=<?= $decembree['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $decembree['name_files'] ?>&size_files=<?= $decembree['size_files'] ?>&dte_files=<?= $decembree['dte_files'] ?>&dte_j=<?= $decembree['dte_j'] ?>&dte_m=<?= $decembree['dte_m'] ?>&dte_a=<?= $decembree['dte_a'] ?>&img_files=<?= $decembree['img_files'] ?>&type_files_note=<?= $decembree['type_files_note'] ?>&type_files_avoir=<?= $decembree['type_files_avoir'] ?>&type_files_fac_achat=<?= $decembree['type_files_fac_achat'] ?>&banque=<?= $decembree['banque'] ?>&type_files_caisse_ventes=<?= $decembree['type_files_caisse_ventes'] ?>&banque=<?= $decembree['banque'] ?>&send_files=<?= $decembree['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $decembree['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                                ...
                                                                <div class="card-body p-50">
                                                                    <div class="app-file-recent-details">
                                                                        <div class="app-file-name font-size-small font-weight-bold"><?= $decembree['name_files'] ?> - <small style="<?php if ($decembree['send_files'] == "#03f322") {
                                                                                                                                                                                        ...
                                                                                                                                                                                        echo "color: #ff0000;";
                                                                                                                                                                                    } ?>"><?php if ($decembree['banque'] == "banque") {
                                                                                                                                                                                                                                                                                                echo "Relevés bancaires";
                                                                                                                                                                                                                                                                                            } else {
                                                                                                                                                                                                                                                                                                echo "ERROR REPORT PLEASE";
                                                                                                                                                                                                                                                                                            } ?></small></div>
                                            ...
                                            <div class="card border shadow-none mb-1 app-file-info">
                                                <div class="card-content">
                                                    <div class="app-file-content-logo card-img-top">
                                                        ...
                                                        <a href="loading/button_valid.php?id=<?= $stockages['id'] ?>&name_entreprise=<?= $entreprise['nameentreprise'] ?>&name_files=<?= $stockages['name_files'] ?>&size_files=<?= $stockages['size_files'] ?>&dte_files=<?= $stockages['dte_files'] ?>&dte_j=<?= $stockages['dte_j'] ?>&dte_m=<?= $stockages['dte_m'] ?>&dte_a=<?= $stockages['dte_a'] ?>&img_files=<?= $stockages['img_files'] ?>&type_files_note=<?= $stockages['type_files_note'] ?>&type_files_avoir=<?= $stockages['type_files_avoir'] ?>&type_files_fac_achat=<?= $stockages['type_files_fac_achat'] ?>&banque=<?= $stockages['banque'] ?>&type_files_caisse_ventes=<?= $stockages['type_files_caisse_ventes'] ?>&banque=<?= $stockages['banque'] ?>&send_files=<?= $stockages['send_files'] ?>&id_session=<?= $_SESSION['id_session'] ?>"><i class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?= $stockages['send_files'] ?>; strokeColorAction: #03f322; colorsOnHover: custom; colorsHoverTime: 0.1 "></i></a>
                                                    ...
                                                    <div class="card-body p-50">
                                                        <div class="app-file-recent-details">
                                                            <div class="app-file-name font-size-small font-weight-bold"><?= $stockages['name_files'] ?> - <small style="<?php if ($stockages['send_files'] == "#03f322") {
                                                                                                                                                                            ...
                                                                                                                                                                            echo "color: #ff0000;";
                                                                                                                                                                        } ?>"><?php if ($stockages['banque'] == "banque") {
                                                                                                                                                                                                                                                                                    echo "Relevés bancaires";
                                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                                    echo "ERROR REPORT PLEASE";
                                                                                                                                                                                                                                                                                } ?></small></div>
