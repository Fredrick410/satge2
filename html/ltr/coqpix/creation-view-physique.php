                                                    ...
                                                    <div id="headingCollapse5" class="card-header d-flex justify-content-between align-items-center" data-toggle="collapse" role="tab" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                                        <div class="collapse-title media">
                                                            ...
                                                            ?>
                                                                ...
                                                                <small class="text-muted d-block">Pièce d'identite, Cerfa M0, Exp professionnel, Justificatif de domicile, Peirl.</small>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card-content">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <br>
                                                                    <div class="form-group">
                                                                        <a href="php/corbeille_societe.php?statut=validenum=<?= $_GET['num'] ?>"><button type="button" class="btn mb-1 btn-outline-danger btn-lg btn-block">Suppression du dossier de création !</button></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
