...
require_once 'php/verif_session_crea.php';
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        ...
        header('Location: creation-view-morale-attestation.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-morale-attestation.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-morale-attestation.php?upload=3');
       exit(); 
}
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-morale-attestation.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
