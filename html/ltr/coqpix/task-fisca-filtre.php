...
require_once 'php/config.php';
    ...
    if($_GET['filter']=="favo"){
        $pdoStat = $bdd->prepare('SELECT * FROM task_fisca WHERE favo_task="yes"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
    }
    else{
        $pdoStat = $bdd->prepare('SELECT * FROM task_fisca WHERE statut_task="'.$_GET['filter'].'"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                <div class="list-group">
                                    <a href="task-fisca.php" class="list-group-item border-0">
                                ...
                                <div class="list-group">
                                    <a href="task-fisca-filtre.php?filter=favo" class="list-group-item border-0 <?php if($_GET['filter'] == "favo"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                    ...
                                    <a href="task-fisca-filtre.php?filter=valide" class="list-group-item border-0 <?php if($_GET['filter'] == "valide"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                    ...
                                    <a href="task-fisca-filtre.php?filter=en cours" class="list-group-item border-0 <?php if($_GET['filter'] == "en cours"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                                        ...
                                                        <div class="todo-item-action d-flex align-items-center">
                                                            ...
                                                            <div class="btn-group ml-2">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right pt-1 px-1" style="min-width: 250px;">
                                                                    <div class="form-group">
                                                                        <form method="POST" action="php/change_task_back.php?num=<?= $tasks['id'] ?>&type=editer_task&categorie=fisca&filter=<?= $_GET['filter'] ?>">
                                                                            <div class="form-group">
                                                                                <label>Nom de la tache <label class="text-danger">*</label></label>
