                                    ...
                                    <div class="card disable-rounded-right d-flex justify-content-center mb-0 p-2 h-100">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2">Modification comptable</h4>
                                            </div>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form class="mb-2" method="POST" action="../php/edit_comptable.php">
                                                <input type="hidden" name="num" value="<?= $comptable['id'] ?>"> 
                                                    <div class="form-group">
                                                        <label class="text-bold-600" for="exampleInputPassword1">Nom : </label>
                                                        <input name="nom" type="text" class="form-control" id="exampleInputPassword1" value="<?= $comptable['nom'] ?>" placeholder="Nom du comptable" required></div>
                                                        <div class="form-group">
                                                        <label class="text-bold-600" for="exampleInputPassword1">Prénom : </label>
                                                        <input name="prenom" type="text" class="form-control" id="exampleInputPassword1" value="<?= $comptable['prenom'] ?>" placeholder="Prénom du comptable" required></div>
                                                    <div class="form-group">
                                                        <label class="text-bold-600" for="exampleInputPassword1">E-mail(Identifiant de connexion) : </label>
                                                        <input name="email" type="email" class="form-control" id="exampleInputPassword1" value="<?= $comptable['email'] ?>" placeholder="E-mail" required></div>
                                                    <div class="form-group mb-2">
                                                        <label class="text-bold-600" for="exampleInputPassword2">Mot de passe (Mot de passe de connexion) :</label>
                                                        <input name="password" type="password" class="form-control" id="exampleInputPassword2" value="<?= $comptable['password_comptable'] ?>" placeholder="Mot de passe"></div>
