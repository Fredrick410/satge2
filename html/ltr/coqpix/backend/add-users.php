                                    ...
                                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="text-center mb-2">Création de compte</h4>
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <p> <small> Veuillez entrer les coordonnées pour inscrire la nouvelle société</small>
                                            </p>
                                        </div>
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form action="../php/insert_societe.php" method="POST">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 mb-50">
                                                            <label for="inputfirstname4">Nom dirigeant :</label>
                                                            <input name="name_diri" type="text" class="form-control" id="inputfirstname4" placeholder="Nom du dirigeant" required>
                                                        </div>
                                                        <div class="form-group col-md-6 mb-50">
                                                            <label for="inputlastname4">Prénom dirigeant :</label>
                                                            <input name="prenom_diri" type="text" class="form-control" id="inputlastname4" placeholder="Prénom du dirigeant" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mb-50">
                                                        <label class="text-bold-600" for="exampleInputUsername1">Nom entreprise :</label>
                                                        <input name="nameentreprise" type="text" class="form-control" id="exampleInputUsername1" placeholder="Nom entreprise" required></div>
                                                    <div class="form-group mb-50">
                                                    ...
                                                    <button type="submit" class="btn btn-primary glow position-relative w-100">Continuer<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                                </form>
                                                <hr>
