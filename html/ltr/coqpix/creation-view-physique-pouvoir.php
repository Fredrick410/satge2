    ...
    <div class="app-content content">
        <div class="content-area-wrapper">
            <div class="sidebar-left">
                <div class="sidebar">
                    <div class="sidebar-content email-app-sidebar d-flex bouge bouge">
                        <!-- sidebar close icon -->
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-physique-pouvoir.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center">  
                                ...
                                <label>Télécharger le document</label>&nbsp&nbsp&nbsp<a href="../../../src/crea_societe/pouvoir/pouvoir-coqpix.pdf" download><label class="livicon-evo" data-options=" name: download.svg; size: 25px "></label></a>
                            </div>
                            <div class="col">
