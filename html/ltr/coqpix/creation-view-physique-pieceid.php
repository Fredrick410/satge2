...
require_once 'php/get_documents_physique.php';
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        ...
        header('Location: creation-view-physique-pieceid.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-physique-pieceid.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-physique-pieceid.php?upload=3');
       exit(); 
}
