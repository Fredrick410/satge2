                            ...
                            <div class="app-file-content p-2">
                                <div class="table-responsive">
                                    <table class="table invoice-data-table dt-responsive nowrap" style="width:100%">
                                        ...
                                        $pdoStattt = $bdd->prepare('SELECT * FROM stockage_admin WHERE id_session=:num AND num_saisie=:num_saisie AND type_files_caisse_ventes = "cas_ventes"');
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="invoice-action text-muted"><br>
                                                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="cloudpix-caisse_view.php?num=<?= $entreprisee['id'] ?>" class="invoice-action-edit cursor-pointer line">
