...
require_once 'php/verif_session_connect_admin.php';
    ...
    $pdoSta = $bdd->prepare('SELECT * FROM comptable');
    $vrai = $pdoSta->execute();
    $comptable = $pdoSta->fetchAll();
            ...
            <div class="content-body">
                ...
                <section class="invoice-list-wrapper">
                    ...
                    <div class="invoice-create-btn mb-1">
                        <a href="backend/add-comptable.php" class="btn btn-primary glow invoice-create" role="button" aria-pressed="true"><i class='bx bx-plus-medical'></i>&nbsp&nbsp&nbsp&nbspAjouter un Comptable</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table invoice-data-table dt-responsive nowrap" style="width:100%">
                            ...
                            <tbody>
                            <?php foreach($comptable as $comptablee): ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td>
                                        <a href="app-invoice.html"><?= $comptablee['nom'] ?></a>
                                    </td>
                                    <td><span class="invoice-amount"><?= $comptablee['prenom'] ?></span></td>
                                    <td><small class="text-muted"><?= $comptablee['email'] ?></small></td>
                                    <td><span class="invoice-customer"><?= $comptablee['role_comptable'] ?></span></td>                                 
                                    <td>
                                        <div class="invoice-action">
                                            <a title="Editer le profile d'un comptable" href="backend/edit-comptable.php?num=<?= $comptablee['id'] ?>" class="invoice-action-view mr-1">
                                                <i class="bx bx-edit"></i>
                                            </a>
                                            <a title="Supprimer un comptable" href="php/delete_comptable.php?num=<?= $comptablee['id'] ?>" class="invoice-action-edit cursor-pointer">
                                                <i class="bx bx-trash"></i>
                                            </a>&nbsp&nbsp&nbsp
                                            <a title="Assignation de client" href="comptable-assignation.php?num=<?= $comptablee['id'] ?>" class="invoice-action-edit cursor-pointer">
                                                <i class='bx bx-usb'></i>
                                            </a>
                                        </div>
                                    </td>
