...
require_once 'php/config.php';
    ...
    $pdoStttt->bindValue(':status_task',"encour");
    $pdoStttt->execute();
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group">
                                    ...
                                    <a href="task-encour.php" class="list-group-item border-0 active">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: timer.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent;"></i>
                                        </span>
                                        <span>En cour</span>
                                    </a>
