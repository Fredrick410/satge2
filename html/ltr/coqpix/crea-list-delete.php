                                                            ...
                                                            <div class="mail-meta-item">
                                                                <span class="float-right">
                                                                    <span class="float-right d-flex align-items-center">
                                                                        <a href="php/corbeille_societe.php?statut=delete&num=<?= $creation['id'] ?>"><i class='bx bx-repeat icons'></i></a>&nbsp&nbsp<a href="php/corbeille_societe.php?statut=trash&num=<?= $creation['id'] ?>"><i class='bx bx-trash icone_red'></i></a>
                                                                    </span>
                                                                </span>
                                                            </div>
                                                        </div>
