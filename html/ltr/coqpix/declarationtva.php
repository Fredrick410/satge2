...
<style>
    .icon{color: #727E8C;}
    .icon:hover{color: #FF5B5C; opacity: 0.5; cursor: pointer;}
</style>
    <!-- BEGIN: Header-->
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    <?php foreach($entreprise as $entreprises): 
                                                        ...
                                                        $pdoSt = $bdd->prepare('SELECT * FROM tva WHERE id_session=:num');   
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?= $nbtva ?></td>
                                                            <td class="text-center"><a href="declarationtva-view.php?num=<?= $entreprises['id'] ?>"><i class='bx bxs-paper-plane icon'></i></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
