...
require_once 'php/verif_session_connect_admin.php';
    ...
    $pdoSta = $bdd->prepare('SELECT * FROM portefeuille WHERE id=:num ');
    $pdoSta->bindValue('num', $_GET['num']);
    $pdoSta->execute();
    $portefeuille = $pdoSta->fetch();

    $pdoSta = $bdd->prepare('SELECT * FROM prelevement WHERE id_session=:num');
    $pdoSta->bindValue('num', $_GET['num']);
    $pdoSta->execute();
    $prelevement = $pdoSta->fetchAll();
?>
<!DOCTYPE html>
                                    ...
                                    <ul class="nav nav-pills flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link d-flex align-items-center" id="account-pill-info" data-toggle="pill" href="#account-vertical-info" aria-expanded="false">
                                                ...
                                                <span>Information de payement</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                        <form action="php/edit_portefeuille.php?num=<?= $portefeuille['id'] ?>&for=first" method="POST">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <label>*Nom de la société</label>
                                                                            <input name="name_entreprise" type="text" class="form-control" placeholder="Nom de la société" value="<?= $portefeuille['name_entreprise'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input name="nom_diri" type="text" class="form-control" placeholder="Nom du dirigeant" value="<?= $portefeuille['nom_diri'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input name="prenom_diri" type="text" class="form-control" placeholder="Prenom du dirigeant" value="<?= $portefeuille['prenom_diri'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input name="tel_diri" type="number" class="form-control" placeholder="Numéros du dirigeant" value="<?= $portefeuille['tel_diri'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <label>E-mail</label>
                                                                            <input name="email_diri" type="email" class="form-control" placeholder="Email du dirigeant" value="<?= $portefeuille['email_diri'] ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                                    <button type="submit" class="btn btn-primary glow mr-sm-1 mb-1">Sauvegarder</button>
                                                                    <a href="portefeuille.php"><button type="button" class="btn btn-light mb-1">Annuler</button></a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="tab-pane fade " id="account-vertical-password" role="tabpanel" aria-labelledby="account-pill-password" aria-expanded="false">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="form-group text-center <?php if($portefeuille['lettredemission'] !== "no"){echo "none-validation";} ?>">
                                                                    <p class="text-center">Aucune lettre de mission ...</p>
                                                                </div>
                                                                <div class="col-md-3 col-6 <?php if($portefeuille['lettredemission'] == "no"){echo "none-validation";} ?>">
                                                                    <div class="form-group">
                                                                        <h5>RIB</h5>
                                                                    </div>
                                                                    <div class="card border shadow-none mb-1 app-file-inf">
                                                                        <div class="card-content">
                                                                            <div class="app-file-content-logo card-img-top">
                                                                                <div class="row">
                                                                                    <div class="col">&nbsp&nbsp&nbsp<a href="../../../src/portefeuille/lettredemission/<?= $portefeuille['lettredemission'] ?>" target="_blank"><i class="bx bxs-note app-file-edit-icon d-block float-right"></i></a><a href="../../../src/portefeuille/lettredemission/<?= $portefeuille['lettredemission'] ?>" download><i class="bx bx-download app-file-edit-icon d-block float-right"></i></a></div>
                                                                                </div>   
                                                                                <br>
                                                                                <br>
                                                                            ...
                                                                            <div class="card-body p-50">
                                                                                <div class="app-file-recent-details">
                                                                                    <div class="app-file-name font-size-small font-weight-bold"><?= $portefeuille['rib'] ?></div>
                                                                ...
                                                                <div class="form-group text-center <?php if($portefeuille['rib'] !== "no"){echo "none-validation";} ?>">
                                                                    <p class="text-center" style="padding-left: 100px;">Aucun RIB ...</p>
                                                                </div>
                                                                <div class="col-md-3 col-6 <?php if($portefeuille['rib'] == "no"){echo "none-validation";} ?>">
                                                                    <div class="form-group">
                                                                        <h5>Lettre de mission</h5>
                                                                    </div>
                                                                    <div class="card border shadow-none mb-1 app-file-inf">
                                                                        <div class="card-content">
                                                                            <div class="app-file-content-logo card-img-top">
                                                                                <div class="row">
                                                                                    <div class="col">&nbsp&nbsp&nbsp<a href="../../../src/portefeuille/rib/<?= $portefeuille['rib'] ?>" target="_blank"><i class="bx bxs-note app-file-edit-icon d-block float-right"></i></a><a href="../../../src/portefeuille/rib/<?= $portefeuille['rib'] ?>" download><i class="bx bx-download app-file-edit-icon d-block float-right"></i></a></div>
                                                                                </div>   
                                                                                <br>
                                                                                <br>
                                                                            ...
                                                                            <div class="card-body p-50">
                                                                                <div class="app-file-recent-details">
                                                                                    <div class="app-file-name font-size-small font-weight-bold"><?= $portefeuille['lettredemission'] ?></div>
                                                                                    <div class="app-file-last-access font-size-small text-muted">Lettre de mission</div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>         
                                                    ...
                                                    <div class="tab-pane fade" id="account-vertical-info" role="tabpanel" aria-labelledby="account-pill-info" aria-expanded="false">
                                                        <form action="php/edit_portefeuille.php?num=<?= $portefeuille['id'] ?>&for=second" method="POST">
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <label>*Estimation en €</label>
                                                                            <input name="estimation" type="number" class="form-control" placeholder="Estimation en €" value="<?= $portefeuille['estimation'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <label>Prix de la facturation en €</label>
                                                                            <input name="prix" type="number" class="form-control" placeholder="Prix en €" value="<?= $portefeuille['prix'] ?>" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <form action="php/insert_prelevement.php?num=<?= $_GET['num'] ?>" method="POST">
                                                                <div class="row">
                                                                    <div class="col">
                                                                        <div class="controls">
                                                                    ...
                                                                    <div class="col">
                                                                        <div class="controls">
                                                                            ...
                                                                            <input name="name_prelevement" type="text" class="form-control" placeholder="Ex: Bilan comptable" value="">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col">
                                                                            ...
                                                                            <div class="card-body card-dashboard">
                                                                                <div class="table-responsive">
                                                                                    <table class="table table-striped dataex-html5-selectors">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <?php foreach($prelevement as $prelevements): ?>
                                                                                                <tr class="table-<?php if($prelevements['statut'] == "En cours"){echo "warning";}elseif($prelevements['statut'] == "Payé"){echo "success";}elseif($prelevements['statut'] == "rejeté"){echo "danger";} ?>">
                                                                                                    ...
                                                                                                    <td class="text-center"><a href='php/change_prelevement.php?KgUf2Ua274=<?= $_GET['num'] ?>&num=<?= $prelevements['id'] ?>&type=payé'><i class='bx bx-check-circle icon_main icon_check <?php if($prelevements['statut'] == "Payé"){echo "none-validation";} ?>'></i></a>  <a href='php/change_prelevement.php?KgUf2Ua274=<?= $_GET['num'] ?>&num=<?= $prelevements['id'] ?>&type=rejeté'><i class='bx bxs-no-entry icon_main icon_no <?php if($prelevements['statut'] == "Payé" || $prelevements['statut'] == "rejeté"){echo "none-validation";} ?>'></i></a>  <a href='php/change_prelevement.php?KgUf2Ua274=<?= $_GET['num'] ?>&num=<?= $prelevements['id'] ?>&type=trash'><i class='bx bx-trash icon_main icon_trash <?php if($prelevements['statut'] == "En cours" || $prelevements['statut'] == "rejeté"){echo "none-validation";} ?>'></i></a> </td>
                                                                                                </tr>
                                                                                            <?php endforeach; ?>
                                                                                        </tbody>
                                                                                        <tfoot>
