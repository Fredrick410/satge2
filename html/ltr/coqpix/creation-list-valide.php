                        ...
                        <div class="email-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-list-valide.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                                            <i class="livicon-evo" data-options="name: check-alt.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent; duration:0.85;">
                                            </i>
                                        </div> 
                                        Créa valide
                                    </a>
                                    ...
                                    <div class="email-user-list list-group">
                                        <ul class="users-list-wrapper media-list">
                                            <?php foreach($crea as $creation): ?>
                                                ...
                                                ?>
                                                <li class="media <?php if($creation['notification_admin'] > "0"){echo "mail-read";} if($pourc >= 100){}else{echo "none-validation";} ?>">
