...
<head>
    ...
    <title>Coqpix - Charge social</title>
                            ...
                            <table id="table-extended-success" class="table mb-0">
                                ...
                                <tbody>
                                    <?php foreach($entreprise as $entreprises): ?>
                                        <tr>
                                            <td class="text-bold-600 pr-0" style="cursor: pointer;"><img class="rounded-circle mr-1" src="../../../app-assets/images/cards/5.png" alt="card"> <?= $entreprises['nameentreprise'] ?></td>
                                            <td class="text-bold-600 pr-0" style="cursor: pointer;"><a href="charge-view.php?num=<?= $entreprises['id'] ?>"><i class='bx bxs-send sendd'></i></a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
