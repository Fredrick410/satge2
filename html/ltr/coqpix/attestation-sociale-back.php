                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    <?php foreach($entreprise as $entreprises): 
                                                        ...
                                                        $pdoSt = $bdd->prepare('SELECT id FROM attestation_sociale WHERE id_session=:num');   
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?= $entreprises['emailentreprise'] ?></td><i class=''></i>
                                                            <td class="text-center"><?= $entreprises['telentreprise'] ?></td>
                                                            <td class="text-center"><i class='bx bxs-donate-heart <?php if($nbdemande == 0){echo "none-validation";} ?>' style='position: relative; top: 3px; color: #00fbff;'></i>&nbsp (<?= $nbdemande ?>)</td>
                                                            <td class="text-center"><a href="attestation-sociale-view.php?num=<?= $entreprises['id'] ?>"><i class='bx bxs-paper-plane icon'></i></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
