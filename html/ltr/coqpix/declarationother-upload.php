...
require_once 'php/config.php';
    ...
    //1
        ...
        if(isset($_FILES['files']) && $_GET['document'] == "decla_cfe"){
            ...
            $path = "../../../src/other_declaration/". $file_name;                     // chemin vers le serveur
            ...
            $date_m = date('m');
            $date_a = date('Y');
            $type_declaration = "decla_cfe";

            $insert = $bdd->prepare('INSERT INTO other_declaration (dte, date_j, date_m, date_a, files_other, type_declaration, id_session) VALUES(?,?,?,?,?,?,?)');
            $insert->execute(array(
                ...
                htmlspecialchars($type_declaration),
                htmlspecialchars($_GET['num'])
            ));
            
            header('Location: declarationother.php');
            exit();
...
<head>
    ...
    <title>Déclaration - Etape 2</title>
        ...
        <div class="content-wrapper">
            <div class="col-lg-12 ">
                <div class="form-group">
                    ...
                    <p>Vous etes sur le point de téléchargé  </p>
                </div>
                <div class="form-group">
