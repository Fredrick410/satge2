                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center border-right">
                                    <img src="../../../app-assets/images/ico/photoxp.png" alt="photoxp" class="img-fluid h-100 p-1">  
                                    <div class="form-group">
                                        <br>
                                    </div>
                                    <label id="download-doc">Pour télécharger le JQPA :</label><br>  
                                    <small>Le JQPA n'est pas obligatoire pour tout le monde seulement pour certains secteurs d'activités,<br> pour plus d'informations contactez-nous via le chat à disposition.</small><br>
