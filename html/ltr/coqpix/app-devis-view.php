...
require_once 'php/permissions_front.php';
    ...
    $sqlt20 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva = '20 %' ) V ";
    ...
    $sqlm20 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva='20 %' ) T ";
    ...
    $sqlt10 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva = '10 %' ) V ";
    ...
    $sqlm10 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva='10 %' ) T ";
    ...
    $sqlt55 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva = '5,5 %' ) V ";
    ...
    $sqlm55 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva='5,5 %' ) T ";
    ...
    $sqlt21 = "SELECT SUM(V.TOTAL) as MONTANT_V FROM ( SELECT cout,quantite,tva ,(((cout * quantite) * (1 - (tva/100)))) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva = '2,1 %' ) V ";
    ...
    $sqlm21 = "SELECT SUM(T.TOTAL) as MONTANT_T FROM ( SELECT cout,quantite ,(cout * quantite ) as TOTAL FROM articles WHERE id_session = :num AND numeros=:numeros AND typ='devisvente' AND tva='2,1 %' ) T ";
                                    ...
                                    <div class="card-body pb-0 mx-25">
                                        ...
                                        <div class="row invoice-info">
                                            <div class="col-6 mt-1">
                                                <h5 class="invoice-from">Devis de</h5>
                                                <div class="mb-1">
                                            ...
                                            <div class="col-6 mt-1">
                                                <h5 class="invoice-to">Devis pour</h5>
                                                <div class="mb-1">
                                                    <span><?= $facture['devispour']; ?></span>
                                                </div>
                                                <div class="mb-1">
