...
require_once 'php/verif_session_crea.php';
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
        ...
        header('Location: creation-view-physique-cerfaM0.php?upload=1');
        exit();

    }else{
        header('Location: creation-view-physique-cerfaM0.php?upload=2');
        exit();
    }
    ...
    if($resultat = move_uploaded_file($target_file, $file_name)){
       ...
       header('Location: creation-view-physique-cerfaM0.php?upload=3');
       exit(); 
}
                        ...
                        <div class="email-app-menu">
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-messages">
                                    ...
                                    <a href="creation-view-physique-cerfaM0.php" class="list-group-item active">
                                        <div class="fonticon-wrap d-inline mr-25">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group text-center border">
                            <br>
                            <h1>Formumaire M0 (Cerfa M0)</h1>
                        </div>
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center">
                                    <img src="../../../app-assets/images/ico/photocerfaM0.png" alt="photocerfa" class="img-fluid">    
                                    <label class="line">Pour télécharger le cerfaM0</label><label class="livicon-evo" data-options=" name: arrow-bottom.svg; size: 25px "></label><br>
                                    <small>Selectionnez le formulaire MO qui correspond à votre forme juridique (Exemple : Formulaire MO SAS)</small><br>
                                    <a href="https://www.google.com/search?safe=strict&client=firefox-b-d&sxsrf=ALeKk02cPeAWOu4C1eIYlY5YaP4kRpMEpQ%3A1610030502622&ei=ph33X9TDJYK78gKI6ILwBg&q=Formulaire+cerfa+M0+pour&oq=Formulaire+cerfa+M0+pour&gs_lcp=CgZwc3ktYWIQAzIFCAAQzQIyBQgAEM0CMgUIABDNAjIFCAAQzQIyBQgAEM0COgQIABBHOgQIIxAnOgIIADoECAAQHjoGCAAQBRAeOgYIABAIEB46CAgAEAgQBxAeOgQIIRAKUMoYWNAgYOYjaABwAngAgAFdiAGRBJIBATaYAQCgAQGqAQdnd3Mtd2l6yAEIwAEB&sclient=psy-ab&ved=0ahUKEwjUrr6Bh4ruAhWCnVwKHQi0AG4Q4dUDCAw&uact=5"><label class="livicon-evo" data-options=" name: download.svg; size: 25px "></label></a>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-group text-center">
                            ...
                            <div class="form-group">
                                <form name="myform" action="" method="POST" enctype="multipart/form-data">
	                                ...
	                                <input class="input-file" id="my-file" onchange="this.form.submit();" type="file"  name="cerfaM0" size="30" accept="image/png, image/jpg, image/jpeg, application/pdf">
                        ...
                        <div class="row no-gutters mt-3">
                            <div class="col"></div>
                            <div class="col text-center">
                                <div class="form-group <?php if(substr($crea['doc_cerfaM0'], -3) == "pdf"){echo "block-validation";}else{echo "none-validation";} ?>">
                                    <embed src=../../../src/crea_societe/cerfaM0/<?= $crea['doc_cerfaM0'] ?> width=800 height=900 type='application/pdf'/>
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_cerfaM0'], -3) == "png"){echo "block-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == "jpg"){echo "block-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == "jpeg"){echo "block-validation";}else{ echo "none-validation";}}} ?>">
                                    <label>Apercu de votre document</label>
                                    <img src="../../../src/crea_societe/cerfaM0/<?= $crea['doc_cerfaM0'] ?>" alt="Photoid" class="img-fluid">
                                </div>
                                <div class="form-group <?php if(substr($crea['doc_cerfaM0'], -3) == "png"){echo "none-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == "jpg"){echo "none-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == "jpeg"){echo "none-validation";}else{ if(substr($crea['doc_cerfaM0'], -3) == "jpeg"){ echo "block-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == "pdf"){echo "none-validation";}else{if(substr($crea['doc_cerfaM0'], -3) == ""){echo "none-validation";}else{echo "block-validation";}}}}}} ?>">
