                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group text-center border-0">
                            <br>
                            <h1>Formulaire M0 (Cerfa M0)</h1>
                        </div>
                        <hr>
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center border-right">
                                    <img src="../../../app-assets/images/ico/photocerfaM0.png" alt="photocerfa" class="img-fluid h-100 p-1">    
                                    <label id="download-doc">Pour télécharger le cerfaM0 :</label><br>
