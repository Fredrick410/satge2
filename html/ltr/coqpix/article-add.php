                ...
                <section class="users-edit">
                    <div class="h-auto card">
                        <div class="card-content">
                            ...
                            <form action="php/insert_article.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <br>
                                                        <button type="button" class="btn btn-primary col-lg-6 col-md-12 mt-25" style="margin-left: 15px" data-toggle="modal" data-target="#popupF" 
                                                        id="#2">Créer un fournisseur</button>
                                                    </div> 
                                                </div> 
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
																						...
																						<div class="modal-content">
																							<div class="h-auto card">
																								<div class="card-content">
                                                                                                    ...
                                                                                                    <ul class="nav nav-tabs mb-2" role="tablist">
                                                                                                        <li class="nav-item">
                                                                                                            <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#accountt" aria-controls="account" role="tab" aria-selected="true">
                                                                                                    ...
                                                                                                    <div class="tab-content">
                                                                                                        <div class="tab-pane active fade show" id="accountt" aria-labelledby="account-tab" role="tabpanel">			
