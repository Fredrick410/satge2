...
<style>
        ...
        <div class="content-wrapper">
            <div class="content-body">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="POST" action="php/insert_portefeuille.php">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        <div class="form-label-group position-relative has-icon-left">
                                            <input type="number" id="password-floating-icon" class="form-control" name="estimation" placeholder="Estimation en €">
                                            <div class="form-control-position">
                                                <i class='bx bx-dollar' ></i>
                                            </div>
                                            <label for="password-floating-icon">Estimation en €</label>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function open_prospect(){
            document.getElementById('bt_prospect').style.display = "none";
            document.getElementById('table-actif').style.display = "none";
            document.getElementById('table-passif').style.display = "none";
            document.getElementById('table-prospect').style.display = "block";
            document.getElementById('bt_actif').style.display = "block";
            document.getElementById('bt_passif').style.display = "block";
        }
        function open_passif(){
            document.getElementById('bt_passif').style.display = "none";
            document.getElementById('table-prospect').style.display = "none";
            document.getElementById('table-actif').style.display = "none";
            document.getElementById('table-passif').style.display = "block";
            document.getElementById('bt_prospect').style.display = "block";
            document.getElementById('bt_actif').style.display = "block";
        }
    </script>
