                                            ...
                                            <table class="table zero-configuration">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">Demande d'attestation</th>
                                                ...
                                                <tbody>
                                                    <?php foreach($entreprise as $entreprises): 
                                                        ...
                                                        $pdoSt = $bdd->prepare('SELECT id FROM attestation_fiscale WHERE id_session=:num');   
                                                        $pdoSt->bindValue(':num',$entreprises['id'], PDO::PARAM_INT);
                                                        $pdoSt->execute();  
                                                        $countt = $pdoSt->fetchAll();
                                                        $nbdemandee = count($countt);

                                                        $pdoSt = $bdd->prepare('SELECT id FROM attestation_fiscale WHERE id_session=:num AND statut_attestation = "En cours"');   
                                                        $pdoSt->bindValue(':num',$entreprises['id'], PDO::PARAM_INT);
                                                        $pdoSt->execute();  
                                                        $count = $pdoSt->fetchAll();
                                                        $nbdemande = count($count);
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><i class='bx bx-diamond <?php if($nbdemande == 0){echo "none-validation";} ?>' style='position: relative; top: 3px; color: #00fbff;'></i>&nbsp (<?= $nbdemandee ?>)</td>
                                                            <td class="text-center"><a href="attestation-fiscale-view.php?num=<?= $entreprises['id'] ?>"><i class='bx bxs-paper-plane icon'></i></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
