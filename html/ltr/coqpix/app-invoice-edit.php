                            ...
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <label class="line">Pour passer la facture en devis</label>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="php/inv-dev.php?id=<?= $facture['id'] ?>"><i class='bx bxs-send size'></i></a>
                                    </div>
                                    ...
                                    <input type="hidden" name="numfacture" value="<?= $facture['id'] ?>">
                                        ...
                                        <div class="row my-2 py-50">
                                            <div class="col-sm-6 col-12 order-2 order-sm-1" style="text-align:center;padding-top:4%">
                                                ...
                                                <input name="nomproduit" id="nomproduit" type="text" class="form-control" placeholder="Nom de la facture" value="<?= $facture['nomproduit'] ?>"> 
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 col-md-12 mt-25">
                                                <div class="form-group">
                                                    ...
                                                    <select name="facturepour" id="facturepour" class="form-control invoice-item-select">
                                                        <option value="<?= $facture['facturepour'] ?>"><?= $facture['facturepour'] ?></option>
                                                        <optgroup label="--------------------------------">
                                                    ...
                                                    <div data-repeater-item>
                                                        ...
                                                        <div class="invoice-item d-flex border rounded mb-1">
                                                            ...
                                                            <div class="invoice-icon d-flex flex-column justify-content-between border-left p-25">
                                                                <div class="dropdown">
                                                                    <a href="php/delete_articles_facture.php?num=<?= $articless['id'] ?>&numfacture=<?= $facture['id'] ?>"><div class="livicon-evo  cursor-pointer dropdown-toggle" data-options=" name: close.svg; size: 15px "></div></a>                                            
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <?php endforeach; ?>
                                                ...
                                                <div class="col-md-5 col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="status_facture" class="form-control invoice-item-select">
                                                            <option value="<?= $facture['status_facture'] ?>"><?= $facture['status_facture'] ?></option>
