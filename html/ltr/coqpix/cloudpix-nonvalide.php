...
require_once 'php/verif_connexion_comptable.php';
    ...
    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="01"');   
    $pdoSt->execute();  
    $janvier = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="02"');   
    $pdoSt->execute();  
    $fevrier = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="03"');   
    $pdoSt->execute();  
    $mars = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="04"');   
    $pdoSt->execute();  
    $avril = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="05"');   
    $pdoSt->execute();  
    $mai = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="06"');   
    $pdoSt->execute();  
    $juin = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="07"');   
    $pdoSt->execute();  
    $juillet = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="08"');   
    $pdoSt->execute();  
    $aout = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="09"');   
    $pdoSt->execute();  
    $septembre = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="10"');   
    $pdoSt->execute();  
    $octobre = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="11"');   
    $pdoSt->execute();  
    $novembre = $pdoSt->fetchAll();

    $pdoSt = $bdd->prepare('SELECT * FROM stockage_admin WHERE send_files="nonvalide" AND dte_m="12"');   
    $pdoSt->execute();  
                        ...
                        <div class="app-file-sidebar-left">
                            ...
                            <div class="app-file-sidebar-content">
                                ...
                                <div class="list-group list-group-messages my-50">
                                    ...
                                    <a href="cloudpix-nonvalide.php" class="list-group-item list-group-item-action active">
                                        <div class="fonticon-wrap d-inline mr-25">
                                            <i class="livicon-evo" data-options="name: dislike.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent; duration:0.85;"></i>
                                        </div> Non valides
                                    </a>
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($fevrierr['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $fevrierr['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($fevrierr['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($marss['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $marss['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($marss['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($avrill['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $avrill['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($avrill['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($maii['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $maii['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($maii['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($juinn['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $juinn['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($juinn['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($juillett['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $juillett['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($juillett['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($aoutt['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $aoutt['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($aoutt['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($septembree['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $septembree['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($septembree['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($octobree['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $octobree['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($octobree['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($novembree['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $novembree['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($novembree['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
                                        ...
                                        <div class="card border shadow-none mb-1">
                                            <div class="card-content">
                                                <div class="card-body px-75 py-50">
                                                    <a href="cloudpix-caisse.php"><div class="app-file-folder-content d-flex align-items-center">
                                                        <div class="app-file-folder-logo mr-75">
                                                            <a href="<?php if($decembree['send_files'] == "valide"){echo "php/ok-by-comptable.php?";}else{echo "saisie.php?";} ?>num=<?= $decembree['id'] ?>&num_ok=two"><div class="livicon-evo app-file-edit-icon d-block float-right" data-options=" name: check-alt.svg; style: lines; size: 20px; strokeColor:<?php if($decembree['send_files'] == "valide"){ echo "rgb(39, 203, 192)";}else{ echo "#FF0000";} ?>; strokeColorAction: rgb(39, 203, 192); colorsOnHover: custom; colorsHoverTime: 0.1 "></div></a>
                                                        </div>
                                                        <div class="app-file-folder-details">
