...
$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND type_files_avoir = "avoir"');
...
$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND type_files_avoir = "avoir" ORDER BY id DESC LIMIT 4');
$pdoSta->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSta->execute();
$recent = $pdoSta->fetchAll();

$pdoSta = $bdd->prepare('SELECT * FROM stockage WHERE id_session = :num AND type_files_avoir = "avoir" ORDER BY id DESC LIMIT 8');
$pdoSta->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSta->execute();
...
$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="01"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$janvier = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="02"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$fevrier = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="03"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$mars = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="04"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$avril = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="05"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$mai = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="06"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$juin = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="07"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$juillet = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="08"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$aout = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="09"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$septembre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="10"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$octobre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="11"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
$novembre = $pdoSt->fetchAll();

$pdoSt = $bdd->prepare('SELECT * FROM stockage WHERE id_session=:num AND type_files_avoir = "avoir" AND dte_m="12"');
$pdoSt->bindValue(':num', $_SESSION['id'], PDO::PARAM_INT);
$pdoSt->execute();
                        ...
                        <div class="app-file-sidebar-left">
                            ...
                            <div class="app-file-sidebar-content">
                                ...
                                <div class="list-group list-group-messages my-50">
                                    ...
                                    <a href="file-manager-avoir.php" class="list-group-item list-group-item-action active">
                                        <div class="fonticon-wrap d-inline mr-25">
                                ...
                                <form action="php/insert_files_stockage_avoir.php" method="POST" enctype="multipart/form-data">
