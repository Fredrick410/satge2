...
require_once 'php/config.php';
    ...
    $pdoSta = $bdd->prepare('SELECT * FROM fournisseur WHERE id = :num');
    $pdoSta->bindValue(':num',$_GET['numfour']);
    $pdoSta->execute();
    $fournisseur = $pdoSta->fetch();
                ...
                <section class="users-edit">
                    <div class="h-auto card">
                        <div class="card-content">
                            ...
                            <form action="php/edit_fournisseur.php" method="POST">
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Nom de la société :</label>
                                                            <input name="name_fournisseur" type="text" class="form-control" placeholder="Nom de la société" value="<?= $fournisseur['name_fournisseur'] ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>Numéros Siret :</label>
                                                            <input name="numsiret" type="text" class="form-control" placeholder="N°Siret" value="<?= $fournisseur['numsiret'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input name="tvaintracom" type="text" class="form-control" placeholder="Tva Intracommunautaire" value="<?= $fournisseur['tvaintracom'] ?>">
                                                        </div>
                                                    </div>
                                                        <div class="controls">
                                                            <label>Iban :</label>
                                                            <input placeholder="FR-" name="iban" type="text" class="form-control" value="<?= $fournisseur['iban'] ?>">
                                                        </div><br>
                                                        <label>*Secteur d'activité :</label>
                                                        <fieldset class="invoice-address form-group">
                                                            <select name="secteur" class="form-control invoice-item-select" required>
                                                                <option value="<?= $fournisseur['secteur'] ?>"><?= $fournisseur['secteur'] ?>"</option>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="tel" type="text" class="form-control" placeholder="Numéros de téléphone de la société" value="<?= $fournisseur['tel'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Email :</label>
                                                            <input name="email" type="text" class="form-control" placeholder="Email du fournisseur" value="<?= $fournisseur['email'] ?>">
                                                        </div>
                                                        </div>
                                                    <div class="form-group">
                                                        <label>Siteweb de la société :</label>
                                                        <input name="siteweb" type="text" class="form-control" placeholder="www.monfournisseur.fr" value="<?= $fournisseur['siteweb'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Adresse :</label>
                                                            <input name="adresse" type="text" class="form-control" placeholder="Adresse du siege fournisseur" required data-validation-required-message="L'e-mail de la societe obligatoire" value="<?= $fournisseur['adresse'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                        ...
                                                        <fieldset class="invoice-address form-group">
                                                            <select name="pays" class="form-control invoice-item-select" required>
                                                                <option value="<?= $fournisseur['pays'] ?>"><?= $fournisseur['name_fournisseur'] ?></option>
                                        ...
                                        <!-- users edit Info form start -->
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>*Nom :</label>
                                                        <input name="nom" class="form-control" type="text" placeholder="Nom du dirigeant" required value="<?= $fournisseur['nom'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>*Prénom :</label>
                                                        <input name="prenom" class="form-control" type="text" placeholder="Prénom du dirigeant" required value="<?= $fournisseur['prenom'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Adresse :</label>
                                                        <input name="adresse_diri" class="form-control" type="text" placeholder="Adresse du dirigeant" value="<?= $fournisseur['adresse_diri'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Téléphone :</label>
                                                        <input name="tel_diri" class="form-control" type="text" placeholder="Téléphone du dirigeant" value="<?= $fournisseur['tel_diri'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>E-mail :</label>
                                                        <input name="email_diri" class="form-control" type="text" placeholder="E-mail du dirigeant" value="<?= $fournisseur['email_diri'] ?>">
                                                    </div>
                                                </div>
