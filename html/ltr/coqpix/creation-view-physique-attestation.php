                    ...
                    <div class="content-body">
                        ...
                        <div class="form-group row align-items-start custom-line">
                            <div class="col text-center border-right">  
                                <img src="../../../app-assets/images/ico/photoattestation.png" alt="photoxp" class="img-fluid h-100 p-1">
                                <div class="form-group">
                                    <br>
                                </div>
                                <label id="download-doc">Télécharger le document :</label><br>
                                <a href="../../../src/crea_societe/attestation/att_non_condamnation-coqpix.pdf" download><label class="livicon-evo" data-options=" name: download.svg; size: 25px "></label></a>
                            </div>
                            <div class="col">
