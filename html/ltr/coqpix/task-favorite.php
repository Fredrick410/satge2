...
require_once 'php/config.php';
    ...
    $pdoStttt = $bdd->prepare('SELECT * FROM task WHERE id_session = :num AND status_task != :status_task AND favorite = :favorite');
    $pdoStttt->bindValue(':num',$_SESSION['id_session']);
    $pdoStttt->bindValue(':status_task',"delete");
    $pdoStttt->bindValue(':favorite',"1");
    $pdoStttt->execute();
                    ...
                    <div class="todo-sidebar d-flex">
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group">
                                    <a href="task-favorite.php" class="list-group-item border-0 active">
                                        <span class="fonticon-wrap mr-50">
                                            <i class="livicon-evo" data-options="name: star.svg; size: 24px; style: lines; strokeColor:#5A8DEE; eventOn:grandparent;"></i>
                                        </span>
                                        <span>Favorie</span>
                                    </a>
