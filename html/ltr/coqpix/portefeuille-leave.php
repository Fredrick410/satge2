    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            <div class="content-body">
                <form action="php/change_portefeuille.php?type=passif&num=<?= $_GET['num'] ?>" method="POST">
                    <div class="form-group">
                        <div class="form-group">
                            <h5>Passage d'un client actif à passif (<?= $_GET['name_entreprise'] ?>)</h5>
                        </div>
                        <div class="form-group">
                            <div class="form-group col-6">
                                <label>Sélectionner une raison :</label><br>
                                <select class="select2 form-control select-light-danger" name="raison">
                                    <option value="Autres" selected>Sélectionner un raison</option>
                                    <optgroup></optgroup>
                                    <option value="Liquidation">Radiation (Société radiée)</option>
                                    <option value="Prix">Prix (Prix trop élevé)</option>
                                    <option value="Manque de service">Manque de service (Mauvais conseil etc ...)</option>
                                    <option value="Litige">Litige</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group text-right">
                            <button class="btn btn-outline-secondary mr-1 mb-1 col-12" type="submit">Continuer</button>
                        </div>
                    </div>
                </form>
            </div>
