                ...
                <section class="users-edit">
                    <div class="h-auto card">
                        <div class="card-content">
                                ...
                                <ul class="nav nav-tabs mb-2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab" href="#account" aria-controls="account" role="tab" aria-selected="true">
                                            <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Info Particulier</span>
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <form action="php/edit_client_particulier.php" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Nom :</label>
                                                            <input name="name_client" type="text" class="form-control" placeholder="Nom du particulier" value="<?= $client['name_client'] ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*prenom :</label>
                                                            <input name="prenom" type="text" class="form-control" placeholder="Prénom du particulier" value="<?= $client['prenom'] ?>" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Adresse :</label>
                                                            <input name="adresse" type="text" class="form-control" placeholder="Adresse du particulier" value="<?= $client['adresse'] ?>">
                                                        </div>
                                                    </div>
                                                        <div class="controls">
                                                            <label>Iban :</label>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="tel" type="text" class="form-control" placeholder="Numéros de téléphone du particulier" value="<?= $client['tel'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Email :</label>
                                                            <input name="email" type="text" class="form-control" placeholder="Email du particulier" value="<?= $client['email'] ?>">
                                                        </div>
                                                        </div>
                                                    <div class="form-group">
                                                        <label>Siteweb de la société :</label>
                                                        <input name="siteweb" type="text" class="form-control" placeholder="www.monclientparticulier.fr" value="<?= $client['siteweb'] ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>*Pays :</label>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                            <div class="form-group">
																...
																<input type="number" name="codePostal" class=" form-control" placeholder="Code Postal" onkeyup="getCpcl($(this))" autocomplete="off">
                                                        ...
                                                        <div class="col-12 col-sm-6">
															<div class="form-group">
																...
																<select name="departement" id="cl" class="form-control " required></select>
															</div>
