...
require_once 'php/verif_session_connect_admin.php';
    ...
    if($_GET['filter']=="favo"){
        $pdoStat = $bdd->prepare('SELECT * FROM task_compta WHERE favo_task="yes"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
    }
    else{
        $pdoStat = $bdd->prepare('SELECT * FROM task_compta WHERE statut_task="'.$_GET['filter'].'"');
        $pdoStat->execute();
        $task = $pdoStat->fetchAll();
    ...
    <nav class="header-navbar navbar-expand-lg navbar navbar-with-menu navbar-static-top navbar-brand-center" style="background-color: #f3e53c;">
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item"><a class="navbar-brand" href="dashboard-admin.php"><div class="brand-logo"><img class="logo" src="../../../app-assets/images/logo/coqpix2.png"></div></a></li>
            </ul>
        </div>
                        ...
                        <div class="todo-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                <div class="list-group">
                                    <a href="task-compta.php" class="list-group-item border-0">
                                ...
                                <div class="list-group">
                                    <a href="task-compta-filtre.php?filter=favo" class="list-group-item border-0 <?php if($_GET['filter'] == "favo"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                    ...
                                    <a href="task-compta-filtre.php?filter=valide" class="list-group-item border-0 <?php if($_GET['filter'] == "valide"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                    ...
                                    <a href="task-compta-filtre.php?filter=en cours" class="list-group-item border-0 <?php if($_GET['filter'] == "en cours"){echo "active";} ?>">
                                        <span class="fonticon-wrap mr-50">
                                ...
                                <div class="form-group">
                                    <form action="php/insert_task_back.php?type=compta" method="POST">
                                        <div class="form-group">
