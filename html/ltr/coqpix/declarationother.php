...
<head>
    ...
    <title>Autres Déclarations</title>
...
<style>
    .icon{color: #727E8C;}
    .icon:hover{color: #e72424; opacity: 0.5; cursor: pointer;}
</style>
    <!-- BEGIN: Header-->
                                            ...
                                            <table class="table zero-configuration">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center">NB DE DECLARATIONS</th>
                                                ...
                                                <tbody>
                                                    <?php foreach($entreprise as $entreprises): 
                                                        ...
                                                        $pdoSt = $bdd->prepare('SELECT * FROM other_declaration WHERE id_session=:num');   
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?= $nbother ?></td>
                                                            <td class="text-center"><a href="declarationother-view.php?num=<?= $entreprises['id'] ?>"><i class='bx bxs-paper-plane icon'></i></a></td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
