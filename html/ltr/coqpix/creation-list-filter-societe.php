                        ...
                        <div class="email-app-menu">
                            ...
                            <div class="sidebar-menu-list">
                                ...
                                <div class="list-group list-group-labels ">
                                    <a href="creation-list-filter-societe.php?filter=SARL" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "SARL"){echo "active";} ?>">
                                        SARL
                                        <span class="bullet bullet-success bullet-sm"></span>
                                    </a>
                                    <a href="creation-list-filter-societe.php?filter=SAS" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "SAS"){echo "active";} ?>">
                                        SAS
                                        <span class="bullet bullet-primary bullet-sm"></span>
                                    </a>
                                    <a href="creation-list-filter-societe.php?filter=SASU" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "SASU"){echo "active";} ?>">
                                        SASU
                                        <span class="bullet bullet-warning bullet-sm"></span>
                                    </a>
                                    <a href="creation-list-filter-societe.php?filter=SCI" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "SCI"){echo "active";} ?>">
                                        SCI
                                ...
                                <div class="list-group list-group-labels">
                                    <a href="creation-list-filter-societe.php?filter=EIRL" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "EIRL"){echo "active";} ?>">
                                        EIRL
                                        <span class="bullet bullet-info bullet-sm"></span>
                                    </a>
                                    <a href="creation-list-filter-societe.php?filter=EI" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "EI"){echo "active";} ?>">
                                        EI
                                        <span class="bullet bullet-light bullet-sm"></span>
                                    </a>
                                    <a href="creation-list-filter-societe.php?filter=Micro-entreprise" class="list-group-item d-flex justify-content-between align-items-center <?php if($_GET['filter'] == "Micro-entreprise"){echo "active";} ?>">
                                        Micro-entreprise
