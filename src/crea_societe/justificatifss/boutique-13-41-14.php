...
<html lang="en">
    <head>
        ...
        <title>White Island | Boutique</title>
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav text-center">
                        ...
                        <a class="nav-item nav-link mr-5" href="boutique.php" style="color: white;border-bottom: 1px solid #3ca918;"">Shop</a>
                    </div>
		...
		<center>
				<p>
				 <a href="https://white-island.tebex.io/" target="_blank">
					  Un lien à utiliser dans les cas où les navigateurs ne supportent
					  pas les <i>iframes</i>.
					</a>
				  </p>
				<iframe
				 src="https://white-island.tebex.io/"
