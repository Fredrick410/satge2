...
(function (window, document, $) {
  ...
  var $param_one = $('#param_one').val();
  var $param_two = $('#param_two').val();
  var $param_three = $('#param_three').val();
  ...
  var donustChartStatistics_2 = {
    ...
    series: [$param_one, $param_two, $param_three],
    labels: ["Acceptée", "Refusée", "En cour"],
    stroke: {
      width: 2
    },
