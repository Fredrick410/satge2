 ...
 */
 function getMessages(){
    ...
    requeteAjax.open("GET", "../../../../html/ltr/coqpix/php/chat_helpdesk_admin.php?destination="+author_id);
  ...
  function postMessage(event){
    ...
    const requeteAjax = new XMLHttpRequest();
    requeteAjax.open('POST', '../../../../html/ltr/coqpix/php/chat_helpdesk_admin.php?task=write');
